...
# -*- coding: utf-8 -*-
#
# easyfuse documentation build configuration file, created by
# sphinx-quickstart on Wed Feb 10 20:30:12 2016.
#
...
def auto_change_docstring(app, what, name, obj, options, lines):
    ...
    """
    if what == 'module' and name.startswith('easyfuse'):
...
def linkcode_resolve(domain, info):
    ...
    base_url = 'https://github.com/JelteF/easyfuse/blob/'
...
modindex_common_prefix = ['easyfuse.']
...
intersphinx_mapping = {
    ...
    'llfuse': ('https://pythonhosted.org/llfuse/', None),
}
...
latex_documents = [
  (master_doc, 'easyfuse.tex', 'easyfuse Documentation',
...
man_pages = [
    (master_doc, 'easyfuse', 'easyfuse Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'easyfuse', 'easyfuse Documentation',
   author, 'easyfuse', 'One line description of project.',
   'Miscellaneous'),
]
